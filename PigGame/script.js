...
const score1El = document.getElementById('score--1'); //different way of selecting ids.
...
//Setting the score to 0s initially
...
btnRoll.addEventListener('click', function () {
  if (playing) {
    ...
    //3. Check for rolled dice if 1:switch to next player.
    if (diceRoll !== 1) {
